...
class Header extends Component {
  state = {
    show: false,
    isLoggedIn: false, // Add state to check if user is logged in
  };
              ...
              >
                  ...
                  <div className="extra-cell">
                    {this.state.isLoggedIn ? (
                      ...
                      <Link
                        ...
                        onClick={this.handleLogin} // Simulate login for demonstration
                      >
                        LOGIN/SIGN UP
                      </Link>
                    )}
                ...
                >
                  ...
                  <ul className="nav navbar-nav">
                    ...
                    <li className="">
                      <Link href="/job-poster">I'M A Job Poster</Link></li>
                    <li className="">
                      <Link href="/">HOW IT'S WORK</Link></li>
                    <li className="">
                ...
                >
                  <div className="form-info text-white align-self-center">
                    ...
                    <ul className="list-inline m-a0">
                      ...
                      <li>
                        <Link href={"#"} className="m-r10 text-white">
                          <i className="fa fa-google-plus"></i></Link>
                      </li>
                      <li>
                        <Link href={"#"} className="m-r10 text-white">
                ...
                <div className="col-lg-6 col-md-6 p-a0">
                  <div className="lead-form browse-job text-left">
                    <form>
                      ...
                      <div className="form-group">
                        <input className="form-control" placeholder="Mobile Number" /></div>
